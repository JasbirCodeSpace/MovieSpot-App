...
<div class="tv-info border-b border-gray-800">
    ...
    alt="{{ $tvShow['name'] }}" class="w-64 md:w-96">
        <div class="md:ml-24">
            ...
            <div class="flex flex-wrap items-center text-gray-400 text-sm">
                ...
                <span
                    class="ml-1">{{ $tvShow['vote_average'] }}</span>
...
<!-- start tv cast  -->
    <div class="tv-cast border-b border-gray-800">
        <div class="container mx-auto px-4 py-16">
            ...
            <div class="flex items-center grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
