    ...
    <nav class="border-b border-gray-800">
        <div class="container mx-auto flex flex-col md:flex-row items-center justify-between px-4 py-6">
            <ul class="flex flex-col md:flex-row items-center">
                ...
                <a href="{{ route('movies.index') }}" class="hover:text-gray-600">Movies</a>
                </li>
                <li class="md:ml-6 mt-4 md:mt-0">
                    <a href="#" class="hover:text-gray-600">Shows</a>
                </li>
                <li class="md:ml-6 mt-4 md:mt-0">
                    <a href="#" class="hover:text-gray-600">Actors</a>
                </li>
            </ul>
            <div class="flex flex-col md:flex-row items-center">
                <div class="relative mt-4 md:mt-0">
                    <input type="text" class="bg-gray-800 text-sm rounded-full w-58 md:w-64 px-4 pl-8 py-1 focus:outline-none focus:shadow-outline" placeholder="Search">
