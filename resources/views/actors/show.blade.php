...
<div class="actor-info border-b border-gray-800">
    <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
        <div class="flex-none">
            <img src="https://m.media-amazon.com/images/I/41521FyNO2L.jpg"
                alt="will smith" class="w-76">
            ...
            <div class="md:ml-24">
                <h2 class="text-3xl font-semibold">Will Smith</h2>
                <div class="flex flex-wrap items-center text-gray-400 text-sm">
                    ...
                    <span
                        class="ml-2">Feb 20, 1983 (37 years old) in Toronto, Canada</span>
                </div>
                <p class="text-gray-300 mt-8">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Sunt nam iure architecto! Mollitia qui voluptas ad recusandae consequatur, rerum exercitationem a, aperiam quae non officiis earum neque accusantium quidem laboriosam.
                </p>
