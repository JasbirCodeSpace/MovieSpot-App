    ...
    <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
        <div class="flex-none">
            <img src="{{ $actor['profile_path'] }}"
                alt="{{ $actor['name'] }}" class="w-76 m-auto">
            ...
            <div class="md:ml-24 mt-10 md:mt-0">
                ...
                <div class="grid grid-cols-1 grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
    ...
    <div class="credits border-b border-gray-800">
        <div class="container mx-auto px-4 py-16">
            <h2 class="text-4xl font-semibold">Credits</h2>
                ...
                <li>{{ $credit['release_year'] }} &middot; <a href="{{ $credit['link_to_page'] }}"><strong>{{ $credit['title'] }}</strong></a> as {{ $credit['character'] }}</li>    
                    @endforeach
                </ul>
        </div>
    </div> <!-- end credits -->
